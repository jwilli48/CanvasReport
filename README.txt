...
To run this program if your PowerShell execution policy is restricted, do the following commands:
...
The first time you run this it will ask you to input your Canvas API and the Canvas Default URL
